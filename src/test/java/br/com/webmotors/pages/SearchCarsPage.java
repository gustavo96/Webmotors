...
public class SearchCarsPage {
    ...
    public void acesarTelaPesquisa() {
        DriverFactory.driver.get("https://www.webmotors.com.br/carros/estoque?tipoveiculo=carros&estadocidade=estoque");
    ...
    public boolean validaCarros(String marca, String modelo, String versao) {
        ...
        DriverFactory.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='carros encontrados']")));
